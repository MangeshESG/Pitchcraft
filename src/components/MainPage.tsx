...
import { faAngleRight, faBars, faBullhorn, faEnvelopeOpen, faGear, faList, } from '@fortawesome/free-solid-svg-icons';
      ...
      {isSidebarOpen && (
        ...
        <li className={`${tab === "Mail" ? "active" : ""} ${showMailSubmenu ? "has-submenu submenu-open" : "has-submenu"}`}>
          <button
            ...
            className="side-menu-button"
          >
            <span className="menu-icon"><FontAwesomeIcon icon={faEnvelope} className=" text-[#333333] text-lg" /></span>
                ...
                >
                  ...
                  {userRole === "ADMIN" && (
                    <li className={tab === "Settings" ? "active" : ""}>
                      ...
                      >
                        <span className="menu-icon">
                          <FontAwesomeIcon icon={faGear} className=" text-[#333333] text-lg" />
                        </span>
